...
from models.models import SizeStandart, GenLib


def parse_file(content: bytes) -> tuple[list[SizeStandart], list[GenLib]]:
    ...
    try:
        ...
        if type_value == 'AllelicLadder':
            ...
            if size_standart_node is not None:
                ...
                size_standarts.append(SizeStandart(
                    title=raw_title,
        ...
        print(ex)
    return size_standarts, gen_libs
